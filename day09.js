...
console.assert(countGarbage("<>") == 0);
console.assert(countGarbage("<random characters>") == 17);
console.assert(countGarbage("<<<<>") == 3);
console.assert(countGarbage("<{!>}>") == 2);
console.assert(countGarbage("<!!>") == 0);
console.assert(countGarbage("<!!!>>") == 0);
console.assert(countGarbage("<{o\"i!a,<{i<a>") == 10);

console.log(countGarbage(day9input));
